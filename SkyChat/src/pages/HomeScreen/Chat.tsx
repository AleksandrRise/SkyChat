...
export default function Chat() {
    ...
    const ulClasses = "overflow-y-auto snap-y flex flex-col gap-10 pl-1 pb-2"
    const liClasses = "flex items-center text-xl snap-end first:mt-5"
    const divClasses = "mt-auto bg-primary py-6.5 px-9 shadow-icons rounded-2xl flex w-full mt-13.75"
    ...
    const photoClasses = "w-17.5 h-17.5 bg-primary rounded-2xl shadow-icons"
    const messageClasses = `px-6.5 py-3.75 rounded-3xl bg-primary shadow-icons mx-7.75
        max-w-3/4`
